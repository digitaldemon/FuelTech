          ...
          <div className="card chat">
            <div className="chat-inner">
              ...
              <div className="bubble-bot">
                ...
                <div style={{ margin: '10px 0', background: '#fff', borderRadius: 8, padding: '6px', display: 'flex', justifyContent: 'center' }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/usm-wiring-diagram.png" alt="USM wiring diagram — Mag Probe to TLS-450PLUS Universal Sensor Module terminal connections" style={{ maxWidth: '100%', borderRadius: 4 }} />
                </div>
