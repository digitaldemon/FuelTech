...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tabs"
  }, [["picks", "Today's picks"], ["analyze", "Analyze a market"], ["parlay", "Parlays"], ["positions", "My trades" + (openTrades ? " (" + openTrades + ")" : "")], ["browse", "Find a market"], ["frameworks", "What I check"], ["ledger", "How I'm doing"]].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    className: tab === k ? "on" : "",
    onClick: () => setTab(k)
  ...
  try {
    ...
    if (game.state === "in") {
      ...
      if (Array.isArray(wp) && wp.length && wp[wp.length - 1].homeWinPercentage != null) {
        return homeProbObj(Number(wp[wp.length - 1].homeWinPercentage) * 100, game, {
          src: "live"
        });
      }
